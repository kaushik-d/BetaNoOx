...
#include "Q3DElasticityElement.hpp"
...
//===============================================================
Q3DElasticityElement::Q3DElasticityElement(void)
{   
...
//====================================================================
void Q3DElasticityElement::calculateBmatrix(InterpAndSolDerivatives *id,
                                            double **b)
{
...
//======================================================================
void Q3DElasticityElement::calculateStrain(InterpAndSolDerivatives *id,
                                           double *strain)
{//engineering shear
     strain[0] = id->p_u1_x1 ;
     strain[1] = id->p_u2_x2 ;
...
//======================================================================
void Q3DElasticityElement::derivativesOfFields(InterpAndSolDerivatives *id)
{
    int i;
    int numberOfInterp = id->numberOfInterp;
...
//===========================================================================
void Q3DElasticityElement::update(char * action, double *uGlobal)
{
